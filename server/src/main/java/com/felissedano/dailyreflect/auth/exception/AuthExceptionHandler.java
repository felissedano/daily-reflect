...
public class AuthExceptionHandler {
    ...
    public ResponseEntity<String> handleBadEmailVerificationRequestException(
            BadEmailVerificationRequestException exception, Locale locale) {
        return new ResponseEntity<>(
                "{\"message\": \"Email already verified or user not exists\"}", HttpStatus.BAD_REQUEST);
    }
    ...
    public ResponseEntity<ProblemDetail> handleBadCredentialsException(
            BadCredentialsException exception, Locale locale) {
